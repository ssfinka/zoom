            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.faq-create') }}" class="btn btn-primary float-right">Tambah FAQ User</a>
                    </div>
                    <div class="card-body">
                        @foreach ($faqs as $faq)
                            <div class="faq">
                                <button class="accordion">
                                    ...
                                    <span class="icons">
                                        ...
                                        <a href="{{ route('admin.faq-edit', $faq->id) }}" class="icon-edit"><i class="fa-solid fa-edit"></i></a>
                                        <i class="fa-solid fa-trash" onclick="toggleDropdown(event)"></i>                                      
                                    </span>
                                </button>
                                <div class="pannel">
                                    <p>{{ $faq->answer }}</p>
